...
#                 f"{CHECK} ``Your row in table`` ``{self.table['name']}`` ``has been updated.``", ephemeral=True
#             )
#         else:
...
#     @app_commands.command(name="table-add-row", description="Add or update your row in the table.")
