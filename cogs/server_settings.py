    ...
    async def _server_settings_logic(self, ctx_or_interaction):
        ...
        view = PageView(
            ...
            page_menus={
                ...
                1: [lambda: SelectChannels_Menu(guild.text_channels, set_user_log_channel, ctx_or_interaction)],
                2: [lambda: SelectChannels_Menu(guild.text_channels, set_manager_log_channel, ctx_or_interaction)],
                3: [lambda: SelectChannels_Menu(guild.text_channels, set_admin_log_channel, ctx_or_interaction)],
